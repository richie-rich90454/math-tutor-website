...
const translations: Record<string, Record<string, string>> = {
    ...
    es: {
        title: "MathTutor IA",
        subtitle:
            "Tu tutor de matem\u00e1ticas personal. Haz cualquier pregunta y obt\u00e9n explicaciones paso a paso.",
    ...
    fr: {
        title: "MathTutor IA",
        subtitle:
            "Votre tuteur de math\u00e9matiques personnel. Posez une question et obtenez des explications \u00e9tape par \u00e9tape.",
    ...
    de: {
        title: "MathTutor KI",
        subtitle:
            "Ihr pers\u00f6nlicher Mathe-Tutor. Stellen Sie eine Frage und erhalten Sie Schritt-f\u00fcr-Schritt-Erkl\u00e4rungen.",
