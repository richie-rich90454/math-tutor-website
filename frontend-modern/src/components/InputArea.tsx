        ...
        <div class="ia-root">
            ...
            {pendingImage && (
                <div class="ia-image-preview">
                    ...
                    <img
                        ...
                        alt="Selected"
                        class="ia-image-preview-img"
                        loading="lazy"
                    />
                    <button
                        class="ia-image-preview-remove"
            ...
            >
                ...
                <button
                    onClick={toggleVoice}
                    disabled={isLoading}
                    class={`ia-util-btn ${isListening ? "is-active" : ""}`}
                    title={
                        isListening
                ...
                {isStreaming ? (
                    <button
                        onClick={onStop}
                        class="ia-action-btn ia-stop-btn"
                    ...
                    <button
                        ...
                        class="ia-action-btn ia-send-btn"
            ...
            <div class="ia-bottom">
                <span class="ia-hint">{t("inputShiftHint")}</span>
                {charCount > 1000 && <span class="ia-char-count">{charCount}</span>}
            </div>
        </div>
    );
});
